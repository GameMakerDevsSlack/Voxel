...
shader_set_uniform_f(shader_get_uniform( shd_ssao_post, "uCameraNear"), obj_camera.cameraNear );
shader_set_uniform_f(shader_get_uniform( shd_ssao_post, "uCameraFar"),  obj_camera.cameraFar );
