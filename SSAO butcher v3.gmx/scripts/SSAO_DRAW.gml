...
draw_text( debugX + 12, debugY - 54 + 4 + 34, "radius=" + string( global.SSAO_RADIUS ) +
                                              "   strength=" + string( global.SSAO_STRENGTH ) +
                                              "   power=" + string( global.SSAO_POWER ) +
                                              "   blur=" + string( global.SSAO_BLUR_PASSES ) );
