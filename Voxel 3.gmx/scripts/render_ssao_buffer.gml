...
shader_set_uniform_f(shader_get_uniform( sh_post_ssao, "uCameraNear"), obj_camera.znear );
shader_set_uniform_f(shader_get_uniform( sh_post_ssao, "uCameraFar"),  obj_camera.zfar );
