...
shader_set_uniform_f( shader_get_uniform( shd_ssao_hlsl, "uCameraFar"  ), obj_camera.cameraFar  );
shader_set_uniform_f( shader_get_uniform( shd_ssao_hlsl, "uCameraNear" ), obj_camera.cameraNear );
