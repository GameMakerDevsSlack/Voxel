...
global.SSAO_RADIUS      = 5.00;  // Radius controls what distance the occluders are measured away from the sample point
global.SSAO_STRENGTH    = 0.06;  // Strength multiplies the SSAO
global.SSAO_POWER       = 4.14;  // Power contrasts the SSAO
